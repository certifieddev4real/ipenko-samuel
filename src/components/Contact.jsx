    ...
    <section id="contact" className="section">
      ...
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          ...
          This is the part where you're already convinced I can help you. Reach out today, and let's talk about how we can move your project forward.
          </p>
          ...
          <div className="flex items-center gap-2 mt-auto">
            {socialLinks.map(({ href, icon }, key) => (
              <a 
                ...
                href={href} 
                target="_blank" 
                className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-orange-600 rounded-full transition-[background-color,color] hover:bg-orange-50 hover:text-orange-500 active:bg-orange-50/80"
              >
                {icon}
              </a>
            ))}
                ...
                <div className="mb-4">
                  <label 
                    ...
                    <input 
                      ...
                      autoComplete="email"
                      required
                      placeholder="certifieddev@example.com" 
                      className="text-field"
                    />
                </div>
              </div>
              ...
              <div className="mb-4">
                <label 
                  ...
                  <textarea 
                    ...
                    placeholder="Wagwan✌🏾"
                    required 
                    className="text-field resize-y min-h-32 max-h-54"
                    ></textarea>
              </div>
